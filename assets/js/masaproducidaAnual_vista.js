$(document).ready(function () {
	...
	$.getJSON("http://localhost/g1646015/sgpt/ApiGrafico/reporteMasaProducidaReal", function (datos) {
		...
		var config = {
			...
			options: {
				...
				title: {
					display: true,
					text: 'Grafica de la masa producida mensual en sucursales'
				},
				tooltips: {
					mode: 'index',
					intersect: false,
				...
				scales: {
					...
					yAxes: [{
						...
						scaleLabel: {
							display: true,
							labelString: 'Valores en Kilo gramos (Kg.)'
						}
					}]
				}
			}
		...
		var ctx = document.getElementById('canvas_masaproducida').getContext('2d');
