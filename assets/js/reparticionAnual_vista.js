$(document).ready(function () {
	...
	$.getJSON("http://localhost/g1646015/sgpt/ApiGrafico/reporteReparticionReal", function (datos) {
		...
		var config = {
			...
			options: {
				...
				title: {
					display: true,
					text: 'Grafica de reparticion mensual por sucursal'
				},
				tooltips: {
					mode: 'index',
					intersect: false,
		...
		var ctx = document.getElementById('canvas_reparticiones').getContext('2d');
