...
$filename="Detalle-de-costos-por-cliente";
//Colores de fondo
...
$spreadsheet->getProperties()->setCreator('SGPT')
    ...
    ->setCategory('Reporte');
// Rename worksheet
$spreadsheet->getActiveSheet()->setTitle('Detalle de costos por cliente');
...
$activeSheet = $spreadsheet->getActiveSheet()
              ->setCellValue('A'.$fila , 'DETALLE DE COSTOS POR CLIENTE');
$fila++;
$spreadsheet->setActiveSheetIndex(0);
$activeSheet = $spreadsheet->getActiveSheet()
