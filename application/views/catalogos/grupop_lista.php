...
<main role="main" >
    <div class="row">
        ...
        <div class="col-2 text-center p-1 mt-1">
          <!-- Button to Open the Modal Nuevo grupop-->
  ...
  <table class="table table-hover ">
    ...
    <?php for($i=0; $i<count($grupop); $i++) {?>
      <tr class="text-center" id="fila_<?php echo $i+1;?>">
        ...
        <td><?php echo $grupop[$i]->id; ?></td>
        <td class="text-left"><?php echo $grupop[$i]->nombre; ?></td>
        <td style="display:none" class="text-center"><?php echo $grupop[$i]->uso; ?></td>
        <td class="text-center"><?php echo icono_reg_uso($grupop[$i]->uso); ?></td>
        <td style="display:none" class="text-center"><?php echo $grupop[$i]->bloqueado; ?></td>
        <td style="display:none"  class="text-center"><?php echo $grupop[$i]->bloqueado; ?></td>
        <td class="text-center"><?php echo icono_reg_bloqueado($grupop[$i]->bloqueado); ?></td>
        <td class="text-right">
...
<div class="modal fade" id="nuevoGrupo">
  <div class="modal-dialog">
    <div class="modal-content">
      <?php echo form_open('Grupop/nuevo'); ?>
      <!-- Modal Header -->
...
<!-- End modal Nuevo grupop -->

<!-- The Modal Actualizar grupop -->
<div class="modal fade" id="actualizarGrupo">
  <div class="modal-dialog">
    <div class="modal-content">
      <?php echo form_open('Grupop/actualizar'); ?>
      <!-- Modal Header -->
...
<!-- End modal Actualizar grupop -->

<!-- The Modal Borrar grupop -->
<div class="modal fade" id="borrarGrupo">
  <div class="modal-dialog">
    <div class="modal-content">
      <?php echo form_open('Grupop/borrar'); ?>
      <!-- Modal Header -->
