...
$filename="Lista-de-materia-prima";
//Colores de fondo
...
$spreadsheet->getProperties()->setCreator('SGPT')
    ...
    ->setCategory('Reporte');
// Rename worksheet
$spreadsheet->getActiveSheet()->setTitle('Materia prima');
...
$activeSheet = $spreadsheet->getActiveSheet()
              ->setCellValue('A'.$fila , 'LISTA DE MATERIA PRIMA');
$fila++;
$spreadsheet->setActiveSheetIndex(0);
$activeSheet = $spreadsheet->getActiveSheet()
...
$activeSheet = $spreadsheet->getActiveSheet()
              ->setCellValue('A'.$fila , $materiaPrima[$i]->id)
              ->setCellValue('B'.$fila , $materiaPrima[$i]->nombre)
              ->setCellValue('C'.$fila , $materiaPrima[$i]->cantidad);
              $fila++;
  }
