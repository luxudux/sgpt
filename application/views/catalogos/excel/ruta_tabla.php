...
$spreadsheet->getProperties()->setCreator('SGPT')
    ...
    ->setCategory('Reporte');
// Rename worksheet
$spreadsheet->getActiveSheet()->setTitle('Rutas');
...
$activeSheet = $spreadsheet->getActiveSheet()
              ->setCellValue('A'.$fila , 'LISTA DE RUTAS');
$fila++;
$spreadsheet->setActiveSheetIndex(0);
$activeSheet = $spreadsheet->getActiveSheet()
...
$activeSheet = $spreadsheet->getActiveSheet()
              ->setCellValue('A'.$fila , $ruta[$i]->id)
              ->setCellValue('B'.$fila , $ruta[$i]->nombre);
              $fila++;
  }
